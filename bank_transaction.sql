...
INSERT INTO `banks` VALUES (3,'BCA'),(1,'BNI'),(2,'BRI'),(4,'Mandiri');
...
INSERT INTO `transactions` VALUES (1,1,'credit',1000000,NULL,'2019-11-19 21:38:51');
...
CREATE TABLE `users` (
  ...
  KEY `bank_id` (`bank_id`),
  CONSTRAINT `users_ibfk_1` FOREIGN KEY (`bank_id`) REFERENCES `banks` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'Riandi','1234567890',1000000,1);
...
INSERT INTO `virtual_accounts` VALUES ('0987654321',1);
...
-- Dump completed on 2019-11-19 21:43:11
